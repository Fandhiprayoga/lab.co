...
<div class="card">
  <div class="card-body">
    <form method="post" action="<?= site_url('admin/consumables/categories/' . (int)($category['id'] ?? 0) . '/update') ?>" id="categoryForm">
      <?= csrf_field() ?>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="number" 
                   ...
                   name="sort_order" 
                   class="form-control" 
                   value="<?= old('sort_order', (int)($category['sort_order'] ?? 0)) ?>" 
                   min="0"
                   placeholder="0">
      ...
      <div class="form-group">
        ...
        <textarea id="description"
                  ...
                  maxlength="1000"><?= old('description', esc($category['description'] ?? '')) ?></textarea>
      </div>
