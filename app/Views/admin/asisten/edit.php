    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="alert alert-info">
          ...
          Ubah penugasan lab untuk asisten <strong><?= esc($user->username) ?></strong>.
          Perubahan hanya memengaruhi lab tempat asisten bertugas, tidak menghapus role asisten.
        </div>

        <form action="<?= base_url('admin/asisten/update/' . (int) $user->id) ?>" method="post">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <small class="form-text text-muted">Kosongkan semua jika asisten tidak ditugaskan ke lab mana pun.</small>
          </div>
