...
<div class="main-sidebar sidebar-style-1">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="<?= isMenuActive('loans/calendar') ?>">
        <a class="nav-link" href="<?= base_url('loans/calendar') ?>"><i class="fas fa-calendar-alt"></i> <span>Kalender</span></a>
      </li>
      ...
      <li class="<?= (strpos($currentUrl, 'loans') === 0) && !isMenuActive('loans/create') && !isMenuActive('loans/analytics') && !isMenuActive('loans/beranda') && !isMenuActive('loans/calendar') ? 'active' : '' ?>">
      ...
      <!-- Manajemen Laboran (superadmin only) -->
      <?php if (activeGroupIs('superadmin')): ?>
      <li class="<?= isMenuActive('admin/laboran') ?>">
        <a class="nav-link" href="<?= base_url('admin/laboran') ?>"><i class="fas fa-user-cog"></i> <span>Manajemen Laboran</span></a>
      </li>
      <?php endif; ?>
      ...
      <li class="<?= isMenuActive('notifications') ?>">
        <a class="nav-link" href="<?= base_url('notifications') ?>">
          ...
          <span class="notif-menu-label">Notifikasi</span>
          <span class="badge badge-danger sidebar-notif-badge d-none" id="sidebar-notif-badge"></span>
        </a>
      </li>
