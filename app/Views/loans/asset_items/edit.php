  ...
  <div class="col-lg-8">
    <div class="card">
      <div class="card-header">
        <h4>Form Edit Item Alat</h4>
      </div>
      <div class="card-body">
        <form action="<?= base_url('admin/loans/asset-items/update/' . (int) ($item['id'] ?? 0)) ?>" method="post">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <select id="asset_id" name="asset_id" class="form-control" required>
              ...
              <?php foreach ($assets as $asset): ?>
                ...
                <option value="<?= $assetId ?>" <?= (int) old('asset_id', (int) ($item['asset_id'] ?? 0)) === $assetId ? 'selected' : '' ?>>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" id="item_code" name="item_code" class="form-control" maxlength="80" required value="<?= old('item_code', $item['item_code'] ?? '') ?>">
            </div>
            <div class="form-group col-md-6">
              <label for="serial_number">Serial Number</label>
              <input type="text" id="serial_number" name="serial_number" class="form-control" maxlength="100" value="<?= old('serial_number', $item['serial_number'] ?? '') ?>">
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" id="location_detail" name="location_detail" class="form-control" maxlength="150" value="<?= old('location_detail', $item['location_detail'] ?? '') ?>">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <?php $selectedCondition = old('condition_status', $item['condition_status'] ?? 'baik'); ?>
            ...
            <div class="form-group col-md-6">
              ...
              <?php $selectedInv = old('inventory_status', $item['inventory_status'] ?? 'aktif'); ?>
          ...
          <div class="form-group">
            <div class="custom-control custom-switch">
              <input type="checkbox" class="custom-control-input" id="is_loanable" name="is_loanable" value="1" <?= old('is_loanable', (string) ($item['is_loanable'] ?? 0)) ? 'checked' : '' ?>>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="date" id="acquisition_date" name="acquisition_date" class="form-control" value="<?= old('acquisition_date', $item['acquisition_date'] ?? '') ?>">
            </div>
            <div class="form-group col-md-6">
              <label for="warranty_until">Garansi Sampai</label>
              <input type="date" id="warranty_until" name="warranty_until" class="form-control" value="<?= old('warranty_until', $item['warranty_until'] ?? '') ?>">
            </div>
          </div>

          <div class="form-group">
            <label for="responsible_user_id">ID Penanggung Jawab (Opsional)</label>
            <input type="number" min="1" id="responsible_user_id" name="responsible_user_id" class="form-control" value="<?= old('responsible_user_id', $item['responsible_user_id'] ?? '') ?>">
          </div>

          <div class="form-group">
            <label for="notes">Catatan</label>
            <textarea id="notes" name="notes" class="form-control" rows="3" maxlength="2000"><?= old('notes', $item['notes'] ?? '') ?></textarea>
          </div>

          <div class="d-flex justify-content-between">
            <a href="<?= base_url('admin/loans/asset-items?asset_id=' . (int) ($item['asset_id'] ?? 0)) ?>" class="btn btn-light">Kembali</a>
